...
+ The CSS specified by ~nice-org-html-css~ may also use the CSS variables defined in et-org-html.css, which ultimately refer to Emacs face attribute values determined by your chosen themes.
